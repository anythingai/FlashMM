...
class HSMInterface:
    ...
    async def generate_key(self, key_id: str, key_type: KeyType, 
        ...
        try:
            ...
            raise SecurityError(f"HSM key generation failed: {e}")
...
class KeyEscrowManager:
    ...
    def reconstruct_key(self, shares: List[str]) -> Optional[bytes]:
...
class EnhancedKeyManager:
    ...
    async def use_key(self, key_id: str, operation: str, 
                     user_id: str, source_ip: Optional[str] = None,
    ...
    async def emergency_key_recovery(self, key_id: str, 
                                   escrow_shares: List[str]) -> Optional[str]:
...
class WarmKeyManager:
    ...
    def _decrypt_key(self, env_var_name: str) -> Optional[str]:
        ...
        try:
            ...
            raise SecurityError(f"Failed to decrypt key {env_var_name}: {e}")
...
class ColdKeyManager:
    ...
    def __init__(self):
        ...
        self.emergency_shutdown_key: Optional[str] = None
...
class KeyRotationManager:
    ...
    async def rotate_hot_keys(self) -> None:
        ...
        try:
            ...
            raise SecurityError(f"Hot key rotation failed: {e}")
