...
from flashmm.data.storage.data_models import HealthCheck, PerformanceMetric
from flashmm.utils.logging import get_logger, PerformanceLogger
...
class EnhancedMetricsCollector:
    ...
    def __init__(self):
        ...
        # Storage clients
        self.influxdb_client: Optional[HighPerformanceInfluxDBClient] = None
        self.redis_client: Optional[HighPerformanceRedisClient] = None
