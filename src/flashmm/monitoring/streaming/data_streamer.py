...
def create_websocket_client(server_url: str, auth_token: Optional[str] = None) -> 'StreamingClient':
...
class StreamingClient:
    ...
    async def subscribe(self, streams: List[str], filters: Optional[Dict[str, Any]] = None,
