...
class SeiClient:
    ...
    def __init__(self):
        ...
        # Client instances
        self.ledger_client: Optional[LedgerClient] = None
        ...
        self._network_health: Optional[NetworkHealth] = None
    ...
    async def _initialize_wallet(self) -> None:
        ...
        try:
            ...
            raise BlockchainError(f"Wallet initialization failed: {e}")
    ...
    async def get_account_info(self, address: Optional[str] = None) -> AccountInfo:
        ...
        try:
            ...
            account_response = await self._rpc_request(
                "abci_query",
                {
                    "path": f"/cosmos.auth.v1beta1.Query/Account",
            ...
            balance_response = await self._rpc_request(
                "abci_query",
                {
                    "path": f"/cosmos.bank.v1beta1.Query/AllBalances",
            ...
            raise BlockchainError(f"Account info query failed: {e}")
    ...
    async def broadcast_transaction(self, tx_bytes: bytes) -> TransactionResult:
        ...
        try:
            ...
            raise BlockchainError(f"Transaction broadcast failed: {e}")
    ...
    async def _rpc_request(self, method: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise BlockchainError(f"RPC request failed: {e}")
