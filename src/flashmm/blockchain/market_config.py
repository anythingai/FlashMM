...
from flashmm.utils.exceptions import ValidationError, ConfigurationError
...
class MarketConfigManager:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise ConfigurationError(f"Market config initialization failed: {e}")
    ...
    def get_market_by_id(self, market_id: str) -> Optional[MarketConfig]:
