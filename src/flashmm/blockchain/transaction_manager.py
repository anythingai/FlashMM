...
class TransactionManager:
    ...
    async def submit_transaction(
        ...
        try:
            ...
            raise BlockchainError(f"Transaction submission failed: {e}")
    ...
    async def submit_batch(
        ...
        try:
            ...
            raise BlockchainError(f"Batch submission failed: {e}")
    ...
    async def _process_batch_results(self, batch: BatchTransaction, results: List[TransactionResult]) -> None:
        ...
        try:
            ...
            for tx_request, result in zip(batch.transactions, results):
                # Store result
                ...
                if tx_request.callback:
                    try:
                        await tx_request.callback(result)
                    except Exception as e:
    ...
    def get_transaction_status(self, tx_id: str) -> Optional[TransactionResult]:
