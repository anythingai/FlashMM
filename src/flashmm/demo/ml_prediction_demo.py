...
from flashmm.monitoring.ml_metrics import get_ml_metrics_collector, MLPerformanceDashboard
...
class MLPredictionDemo:
    ...
    async def demo_basic_prediction(self) -> None:
    ...
    async def demo_inference_engine_compatibility(self) -> None:
        ...
        if legacy_prediction:
            logger.info(f"✅ Legacy prediction successful:")
