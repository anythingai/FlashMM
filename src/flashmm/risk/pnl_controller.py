...
class DrawdownMetrics:
    ...
    time_to_recovery_estimate_hours: float | None = None
...
class StopLossOrder:
    ...
    initial_position_value: Decimal | None = None
...
class DrawdownProtector:
    ...
    def __init__(self):
        ...
        self.drawdown_start_time: dict[PnLPeriod, datetime | None] = {}
        self.protection_actions_taken: list[dict[str, Any]] = []

        # Callbacks for protection actions
        self.position_reduction_callback: Callable | None = None
        self.spread_widening_callback: Callable | None = None
        self.trading_halt_callback: Callable | None = None
        ...
        try:
            ...
            if current_drawdown > 0:
                if self.drawdown_start_time[period] is None:
                    ...
                    start_time = self.drawdown_start_time[period]
    ...
    def set_callbacks(self,
                      position_reduction: Callable | None = None,
                      spread_widening: Callable | None = None,
                      trading_halt: Callable | None = None):
...
class StopLossManager:
    ...
    async def create_stop_loss(self,
        ...
        async with self._lock:
            try:
                ...
                raise RiskError(f"Stop-loss creation failed: {e}") from e
    ...
    async def cancel_stop_loss(self, symbol: str, stop_type: StopLossType | None = None):
    ...
    def get_active_stops(self, symbol: str | None = None) -> dict[str, list[StopLossOrder]]:
...
class PnLRiskController:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise RiskError(f"P&L risk controller initialization failed: {e}") from e
    ...
    async def update_pnl_and_check_risks(self,
        ...
        async with self._lock:
            try:
                ...
                raise RiskError(f"P&L risk check failed: {e}") from e
    ...
    async def cancel_position_stops(self, symbol: str, stop_type: StopLossType | None = None):
        """Cancel stop-loss orders for a position."""
        await self.stop_loss_manager.cancel_stop_loss(symbol, stop_type)

    def get_pnl_summary(self, symbol: str | None = None) -> dict[str, Any]:
    ...
    async def reset_drawdown_tracking(self, period: PnLPeriod | None = None):
    ...
    async def update_risk_limits(self,
                               ...
                               position_loss_limit: Decimal | None = None,
    ...
    async def assess_pnl_risk(self, symbol: str, current_pnl: Decimal, position_value: Decimal) -> dict[str, Any]:
        """Assess P&L risk for a position (compatibility method)."""
        try:
            return await self.update_pnl_and_check_risks(
                symbol=symbol,
            ...
            logger.error(f"Error assessing P&L risk for {symbol}: {e}")
    ...
    def set_alert_callback(self, callback: Callable) -> None:
        ...
        logger.info("Alert callback set for P&L risk controller")

    async def update_pnl(self, symbol: str, realized_pnl: Decimal, unrealized_pnl: Decimal, position_value: Decimal) -> dict[str, Any]:
        """Update P&L (compatibility method)."""
        return await self.update_pnl_and_check_risks(symbol, realized_pnl, unrealized_pnl, position_value)
