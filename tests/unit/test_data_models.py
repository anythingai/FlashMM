...
class TestOrderBookLevel:
    ...
    def test_valid_orderbook_level(self):
        ...
        level = OrderBookLevel(price=Decimal("0.042"), size=Decimal("1000.0"))
        assert level.price == Decimal("0.042")
        assert level.size == Decimal("1000.0")

    def test_decimal_conversion(self):
        """Test automatic decimal conversion."""
        level = OrderBookLevel(price=Decimal("0.042"), size=Decimal("1000"))
    ...
    def test_invalid_price(self):
        ...
        with pytest.raises(ValidationError):
            OrderBookLevel(price=Decimal("0"), size=Decimal("1000"))

        with pytest.raises(ValidationError):
            OrderBookLevel(price=Decimal("-1"), size=Decimal("1000"))

    def test_invalid_size(self):
        """Test invalid size validation."""
        with pytest.raises(ValidationError):
            OrderBookLevel(price=Decimal("0.042"), size=Decimal("-100"))
...
class TestOrderBookSnapshot:
    ...
    def test_best_prices(self):
        ...
        bids = [
            OrderBookLevel(price=Decimal("0.042"), size=Decimal("1000")),
            OrderBookLevel(price=Decimal("0.041"), size=Decimal("500"))
        ]
        asks = [
            OrderBookLevel(price=Decimal("0.043"), size=Decimal("1000")),
            OrderBookLevel(price=Decimal("0.044"), size=Decimal("500"))
        ]
    ...
    def test_spread_bps_calculation(self):
        ...
        bids = [OrderBookLevel(price=Decimal("100"), size=Decimal("1000"))]
        asks = [OrderBookLevel(price=Decimal("101"), size=Decimal("1000"))]
    ...
    def test_crossed_book_validation(self):
        ...
        bids = [OrderBookLevel(price=Decimal("0.045"), size=Decimal("1000"))]  # Higher than ask
        asks = [OrderBookLevel(price=Decimal("0.043"), size=Decimal("1000"))]
    ...
    def test_bid_ordering_validation(self):
        ...
        bids = [
            OrderBookLevel(price=Decimal("0.041"), size=Decimal("1000")),  # Wrong order
            OrderBookLevel(price=Decimal("0.042"), size=Decimal("500"))
        ]
        asks = [OrderBookLevel(price=Decimal("0.043"), size=Decimal("1000"))]
    ...
    def test_ask_ordering_validation(self):
        ...
        bids = [OrderBookLevel(price=Decimal("0.042"), size=Decimal("1000"))]
        asks = [
            OrderBookLevel(price=Decimal("0.044"), size=Decimal("1000")),  # Wrong order
            OrderBookLevel(price=Decimal("0.043"), size=Decimal("500"))
        ]
...
class TestPosition:
    ...
    def test_position_properties(self):
        ...
        position = Position(
            ...
            quote_balance=Decimal("-42"),
            unrealized_pnl=Decimal("5.0"),
            realized_pnl=Decimal("2.0"),
            last_updated=datetime.now(),
            average_entry_price=Decimal("0.041")
        )
    ...
    def test_short_position(self):
        ...
        position = Position(
            symbol="SEI/USDC",
            base_balance=Decimal("-500"),
            quote_balance=Decimal("21"),
            last_updated=datetime.now(),
            average_entry_price=Decimal("0.042")
        )
    ...
    def test_flat_position(self):
        ...
        position = Position(
            ...
            last_updated=datetime.now(),
            average_entry_price=Decimal("0.040")
        )
    ...
    def test_invalid_price(self):
        ...
        with pytest.raises(ValidationError):
            OrderRequest(
                ...
                price=Decimal("0"),
                size=Decimal("1000"),
                client_order_id="invalid_price_test"
            )
    ...
    def test_invalid_size(self):
        ...
        with pytest.raises(ValidationError):
            OrderRequest(
                ...
                price=Decimal("0.042"),
                size=Decimal("0"),
                client_order_id="invalid_size_test"
            )
...
class TestOrderResponse:
    ...
    def test_fill_percentage_calculation(self):
        ...
        order = OrderResponse(
            ...
            timestamp=datetime.now(),
            filled_size=Decimal("250"),
            remaining_size=Decimal("750"),
            average_fill_price=Decimal("0.041")
        )
    ...
    def test_fully_filled_order(self):
        ...
        order = OrderResponse(
            order_id="12345",
            client_order_id="client_12345_filled",
            symbol="SEI/USDC",
            side=Side.BUY,
            price=Decimal("0.042"),
            size=Decimal("1000"),
            ...
            average_fill_price=Decimal("0.042")
        )
...
class TestMLPrediction:
    ...
    def test_valid_prediction(self):
        ...
        prediction = MLPrediction(
            ...
            feature_importance={"price_trend": 0.8, "volume": 0.6}
        )
    ...
    def test_bearish_prediction(self):
        ...
        prediction = MLPrediction(
            ...
            signal_strength=-0.5,
            model_version="v1.0.0",
            feature_importance={"price_trend": 0.4, "volume": 0.3}
        )
